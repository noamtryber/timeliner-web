...
export const EnterprisePlan = ({ content }: EnterprisePlanProps) => {
  ...
  return (
    <Card className={`relative border border-[#2A2F3C] bg-[#151a25] p-4 flex flex-col animate-fade-up delay-600 hover:scale-105 transition-transform duration-300 z-[1] ${isRTL ? 'text-right' : ''}`}>
