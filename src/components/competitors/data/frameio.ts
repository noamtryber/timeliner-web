...
export const frameioData: Competitor = {
  ...
  features: [
      ...
      keyTakeaways: [
        {
          ...
          spanishText: 'Frame.io es excelente para almacenamiento rápido y revisión de videos, pero su costo se dispara a medida que el equipo crece y carece de CRM, gestión de proyectos y herramientas de marketing.'
        },
        {
          type: 'positive',
          ...
          spanishText: 'Timeliner lo tiene todo en un solo lugar – gestión de proyectos, revisión de videos, almacenamiento de medios, CRM, herramientas de marketing, construcción de portafolios e integraciones inteligentes con WhatsApp, correo y Slack.'
        },
        {
          type: 'positive',
          ...
          spanishText: 'Su precio fijo garantiza que no haya costos ocultos, lo que hace de Timeliner la opción más rentable y completa para editores de video, videógrafos, agencias creativas y equipos de postproducción.'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      spanishName: "Enlaces de revisión fáciles para clientes",
      competitor: true,
      timeliner: true
    },
    {
      ...
      spanishName: "Flujo de trabajo avanzado de gestión de estado de medios",
    ...
    },
    {
      ...
      spanishName: "No se requiere cuenta para revisores",
      competitor: false,
      timeliner: true
    },
    {
    ...
    },
    {
      ...
      spanishName: "Monitoreo del equipo y seguimiento de productividad",
      competitor: false,
      timeliner: true
    },
    {
      ...
      spanishName: "Agregar comentarios con grabaciones de voz",
      competitor: false,
      timeliner: true
    },
    {
      ...
      spanishName: "Subtítulos AI en múltiples idiomas",
      competitor: false,
      timeliner: true
    },
    {
      ...
      spanishName: "Constructor de portafolios profesionales",
      competitor: false,
      timeliner: true
    },
    {
      ...
      spanishName: "Recursos educativos y onboarding 1 a 1",
      competitor: false,
      timeliner: true
    },
    {
      ...
      spanishName: "El costo aumenta exponencialmente a medida que el equipo crece",
      ...
      spanishTimeliner: "Precio fijo cubre hasta 30 usuarios sin tarifas adicionales"
    }
  ]
};