  ...
  features: [
    {
      ...
      keyTakeaways: [
        ...
        },
        {
          ...
          spanishText: 'Timeliner es una solución todo en uno que combina gestión de proyectos, revisión de videos, almacenamiento de medios, CRM, herramientas de marketing y creación de portafolios en una plataforma.'
        },
        {
          type: 'positive',
