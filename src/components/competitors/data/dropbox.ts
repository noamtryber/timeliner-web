      ...
      keyTakeaways: [
        {
          ...
          spanishText: 'Dropbox Replay es principalmente un complemento de revisión que requiere Dropbox Plus para una funcionalidad completa, lo que lo convierte en $20/usuario/mes, una suma que aumenta rápidamente a medida que los equipos crecen.',
