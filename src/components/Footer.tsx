      ...
      <div className="container mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg relative overflow-hidden">
          ...
          <div 
            ...
            style={{
              backgroundImage: "url('/lovable-uploads/ba363fbf-d1cd-4358-be38-6c6524bea241.png')",
...
<lov-code>
Let's update the Footer component to use the new background image with 70% opacity:
