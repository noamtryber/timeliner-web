            ...
            return (
              <div key={group.id} className="space-y-8 md:space-y-12">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 items-center">
                  ...
                  <div className={`col-span-1 md:col-span-2 space-y-2 flex flex-col order-2 ${index % 2 === 0 ? 'md:order-1' : 'md:order-3'}`}>
                  ...
                  {currentFeature && (
                    <div className={`col-span-1 md:col-span-4 order-3 ${index % 2 === 0 ? 'md:order-2' : 'md:order-2'}`}>
                  ...
                  <div className={`col-span-1 md:col-span-5 order-1 flex items-center
                    ${index % 2 === 0 
                      ...
                      : 'md:col-start-1 md:order-1 md:-ml-[30%]'
                    }`}>
