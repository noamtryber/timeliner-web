  ...
  return (
    <>
      <button 
        ...
        className="text-white hover:text-white px-3 py-2 rounded-md text-[1.2em] font-medium ml-8"
      >
        {translations.features[language as keyof typeof translations.features] || content?.features_link || 'Features'}
      </button>
      <button 
        onClick={() => handleSectionClick('testimonials')} 
        className="text-white hover:text-white px-3 py-2 rounded-md text-[1.2em] font-medium"
      >
